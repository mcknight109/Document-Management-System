...
// --- Fetch ALL documents for table display ---
$documentsResult = $conn->query("SELECT * FROM documents ORDER BY id DESC");
$allDocuments = [];
if ($documentsResult && $documentsResult->num_rows > 0) {
        ...
        <div class="table-container">
            ...
            <script>
                document.addEventListener("DOMContentLoaded", () => {
                    const rowsPerPage = 10; // Change this to display more/less rows per page
