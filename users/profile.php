...
if ($result->num_rows > 0) {
    ...
    // Properly fetch created_at
    $createdDate = !empty($user['created_at'])
        ? date("M d, Y", strtotime($user['created_at']))
        : "—";

    // Properly fetch permissions
    $permissions = [];
                ...
                <div class="text-center mb-4">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value badge-role <?= $user['role']; ?>">
                                <?= ucfirst($user['role']); ?>
                            </span>
                        </div>
                        ...
                        <div class="permissions-section">
                            <div class="label"><strong>Permissions</strong></div>

                            <?php if (!empty($permissions)): ?>
                                <ul class="permission-list">
                                    <?php foreach ($permissions as $perm): ?>
                                        <li><i class="fas fa-check-circle"></i> <?= htmlspecialchars($perm); ?></li>
                                    <?php endforeach; ?>
                                </ul>
                            <?php else: ?>
                                <p class="no-permission">
                                    <i class="fas fa-ban"></i> No specific permissions assigned
                                </p>
                            <?php endif; ?>
                        </div>
                ...
                <form action="Controllers/ProfileController.php" method="POST" class="mt-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-lg rounded-3 shadow-sm border-0"
                                id="middle_initial" name="middle_initial" value="<?php echo htmlspecialchars($user['middle_initial']); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 mt-4">
                        ...
                        <input type="password" class="form-control form-control-lg rounded-3 shadow-sm border-0"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-4">
                        <button type="submit" name="update_profile"
                            class="btn btn-lg px-4 rounded-3 shadow-sm d-flex align-items-center gap-2"
